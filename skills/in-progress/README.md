...
- **[codex-handoff](./codex-handoff/SKILL.md)** — Fork the current Codex task with its completed history, then send the latest continuation objective to the new task. User-invoked.
