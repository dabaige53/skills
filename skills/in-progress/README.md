...
- **[codex-handoff](./codex-handoff/SKILL.md)** — Summarize the current conversation and launch a fresh Codex task that starts working from that distilled context. User-invoked.
